...
@section('page-name', 'Edit Album Sekolah')
                    ...
                    <div class="card-body py-1 table-responsive">
                        <form role="form" action="{{ route('admin.album.update', $album->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ old('name', $album->name ?? '') }}" class="form-control @error('name') is-invalid @enderror" id="" placeholder="Masukkan nama album">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" placeholder="Masukkan deskripsi singkat" class="form-control @error('description') is-invalid @enderror">{{ old('description', $album->description ?? '') }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="">Status</label>
                                <div>
                                <input type="checkbox" value="1" {{ $album->is_active == true ? 'checked':'' }} name="status" data-on-text="Aktif" data-off-text="Tidak Aktif" data-bootstrap-switch data-off-color="danger" data-on-color="primary">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="">Gambar<span class="text-danger small"> (jika tidak memilih gambar maka gambar sebelumnya yang digunakan)</span></label>
